...
class ReviewEmailSenderTest {
    ...
    private ReviewEmailSender reviewEmailSender;
    ...
    void setUp() {
        ...
        reviewEmailSender = new ReviewEmailSender(emailSender, templateEngine, reviewCycleService, fixedClock);
    }
    ...
    void sendReviewMail_success() {
        ...
        final ReviewSendElement element = ReviewSendElement.of(targetEmail, targetUrls);
    ...
    void sendReviewMail_templateReceivesUrls() {
        ...
        final ReviewSendElement element = ReviewSendElement.of(Email.from("user@test.com"), targetUrls);
        final ReviewSendOutput output = new ReviewSendOutput(List.of(element));
        ...
        assertThat(capturedUrls.getFirst().getValue()).isEqualTo("https://example.com/article1");
        assertThat(capturedUrls.get(1).getValue()).isEqualTo("https://example.com/article2");
    }
}
